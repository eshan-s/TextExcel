...
*/
        ...
        public void testTransitiveNontrivialReferences()
        {
            ...
            System.out.println("F3=" + (grid.getCell(new TestLocation(2, 5))).abbreviatedCellText());
            grid.processCommand("F4 = ( 1.0 * F2 + F3 - 0.0 )");
            System.out.println("F4=" + (grid.getCell(new TestLocation(3, 5))).abbreviatedCellText());
            String outerFormula = "( 1.0 - 1 + F3 + F4 * 1.0 )";
            grid.processCommand("F5 = " + outerFormula);
            System.out.println("F5=" + (grid.getCell(new TestLocation(4, 5))).abbreviatedCellText());
            Cell cell = grid.getCell(new TestLocation(4, 5));
            assertEquals("Fib(5)", Helper.format("5.0"), cell.abbreviatedCellText());
        ...
        public void testVertical()
        {
            ...
            System.out.println("C4=" + (grid.getCell(new TestLocation(3, 2))).abbreviatedCellText());
            grid.processCommand("C5 = ( C4 - C3 )"); // 1
            System.out.println("C5=" + (grid.getCell(new TestLocation(4, 2))).abbreviatedCellText());
            grid.processCommand("C6 = ( 32 - C4 )"); // 30
            System.out.println("C6=" + (grid.getCell(new TestLocation(5, 2))).abbreviatedCellText());
